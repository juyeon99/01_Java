...
//            }
            ...
            if(!strResTime.equals("")){
                String[] resTimeArr = strResTime.split(":");
                reservation_time = LocalTime.of(
                        Integer.parseInt(resTimeArr[0]),
                        Integer.parseInt(resTimeArr[1]));
            }

            String strCreatedAt = arr[8];
            LocalDateTime created_at = null;
            if(!strCreatedAt.equals("")){
                String[] createdAtArr = strCreatedAt.split("T");
                String date = createdAtArr[0];
                String time = createdAtArr[1];
