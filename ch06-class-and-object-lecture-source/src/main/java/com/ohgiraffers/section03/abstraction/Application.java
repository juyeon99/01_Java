...
public class Application {
    public static void main(String[] args) {
         ...
         * 현실세계에서 불가능한 무생물이나 개념같은 존재들도 하나의 주체로 본인의
         * 상태를 스스로 제어하고 행동하도록 한다는 것이 현실세계와 다른 점.
         * 모든 객체는 책임을 가지고 자신의 역할을 수행해야 한다.
         * 또한 하나의 객체는 너무 많은 일을 수행하는 것이 아닌 적절한 책임을 가지고 있어야 한다. => 단일 책임의 원칙
         * */

        /*
         * 객체를 설계하기 위해서는 현실세계를 그대로 반영하기엔 너무 방대하고 복잡하기 때문에
         * 현실 세계를 프로그램의 목적에 맞게 단순화하는 추상화라는 기법 적용
         * */
         ...
         * 객체의 재사용성이 증가하면 중복되는 코드를 줄일 수 있고 오류 발생을 최소화
         * */
         ...
         * 2. 자동차는 시동걸기, 엑셀 밟기, 브레이크 밟기, 시동 끄기를 할 수 있다.
         * 3. 자동차는 처음에 멈춘 상태로 대기하고 있는다.
         * 4. 카레이서는 먼저 자동차에 시동을 건다. (이미 걸려있는 경우 다시 시동을 걸 수 없다.)
         * 5. 카레이서가 엑셀을 밟으면 시동이 걸린 상태일 경우, 자동차는 시속이 10km/h 증가하며 앞으로 나간다.
